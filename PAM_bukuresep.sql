...
MySQL - 5.5.36 : Database - db_kawaldesaku
*********************************************************************
*/
...
insert  into `binamasyarakat`(`id_bina_masyarakat`,`id_desa`,`jenis_kegiatan`,`lokasi`,`volume`,`satuan`,`biaya`,`start_date`,`due_date`) values (1,5,'pelayanan terpadu','Silimbat',500,0,2000000,'2013-10-30','2013-12-01'),(2,4,'pelayanan anak','sigumpar',400,0,2000000,'2016-04-22','2016-04-22'),(4,6,'Pembinaan Ibu Rumah Tangga','Nagahuta',30,12,40000000,'2016-04-28','2016-04-30'),(5,6,'Pembinaan Nelayan','Pelabuhan',200,21,30000000,'2016-04-27','2016-04-23'),(6,13,'Gotong Royong','Jl Perbauangan',200,1,900000,'2014-05-13','2015-04-21'),(7,13,'Pengajaran Balita Desa','Inalang',30,1,10000000,'2016-04-25','2016-05-27'),(9,13,'Pembinaan Ibu Rumah Tangga','Nagahuta',200,1,30000000,'2016-04-29','2016-04-29');
...
insert  into `dayamasyarakat`(`id_daya_masyarakat`,`id_desa`,`jenis_kegiatan`,`lokasi`,`volume`,`satuan`,`biaya`,`start_date`,`due_date`) values (2,5,'Pelepuhan Batu ','Parbatuan',200,0,3000000,'2013-02-11','2014-03-27'),(3,6,'Desa Mengajar','Nagasaribu',30,10,400000,'2016-04-27','2016-04-30'),(4,13,'Penyuluhan Ibu PKK','Jalan Gereja',25,1,2000000,'2016-04-27','2016-04-30');
...
CREATE TABLE `desa` (
  ...
  CONSTRAINT `desa_ibfk_1` FOREIGN KEY (`id_kabupaten`) REFERENCES `kabupaten` (`id_kabupaten`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `desa_ibfk_2` FOREIGN KEY (`id_provinsi`) REFERENCES `provinsi` (`id_provinsi`) ON DELETE CASCADE ON UPDATE CASCADE,
...
insert  into `desa`(`id_desa`,`id_kecamatan`,`id_kabupaten`,`id_provinsi`,`nama_desa`,`deskripsi_desa`) values (1,1,5,1,' Horsik',NULL),(2,1,5,1,'Motung',NULL),(3,2,5,1,' Aek Bolon Jae',NULL),(4,2,5,1,'Huta Dame',NULL),(5,2,5,1,'Matio',NULL),(6,3,5,1,'Lintong',NULL),(7,3,5,1,'Rianiate',NULL),(8,3,5,1,'Pangururan',NULL),(9,4,5,1,' Panamparan',NULL),(10,4,5,1,'Hitetano',NULL),(11,5,5,1,' Sibadihon',NULL),(12,5,5,1,'Sihiong',NULL),(13,2,5,1,'Balige',NULL);
...
insert  into `pembangunandesa`(`id_pemb_desa`,`id_desa`,`jenis_pembangunan_desa`,`jenis_kegiatan`,`lokasi`,`volume`,`satuan`,`biaya`,`start_date`,`due_date`) values (3,13,4,'Kebersihan lingkungan','Jl. Uttaran',1,0,1000000,'2016-04-05','2016-04-19'),(4,6,3,'Pembangunan Polindes','Jl Parhitean',5,0,7800000,'2015-06-16','2016-02-01'),(5,6,2,'Pembangunan Irigasi','Nagasaribu',300,10,5000000,'2016-04-28','2016-05-01');
...
insert  into `penyelenggaraanpemdes`(`id_peny_pemdesa`,`id_desa`,`jenis_kegiatan`,`lokasi`,`volume`,`satuan`,`biaya`,`start_date`,`due_date`) values (2,4,'pemberdayaan masyarakat','Pardede Onan',20,0,20000000,'2006-10-24','2007-02-01'),(3,5,'Pembangunan Jalan','Jl. Perikanan',500,0,12000000,'2012-06-13','2013-09-05'),(4,6,'Pembentukan RT','Nagasaribu',30,10,45000000,'2016-04-28','2016-04-30'),(5,13,'Pembentukan RW','Jl Samsat',20,1,5000000,'2016-04-25','2016-04-30');
...
insert  into `terminbinmas`(`id_terminbinmas`,`id_binmas`,`keterangan`,`foto_1`,`foto_2`,`foto_3`,`foto_4`,`foto_5`,`deskripsi`) values (1,1,'pelayanan terpadu','','',NULL,NULL,NULL,'terlaksana dengan baik\r\n'),(5,1,'50%','FqjJvbZTIGl1yPM2idaL7ScD8avqD-L3.png','JVX_L9PD2ndJ7n_5PDi7A_7iUSHyIeub.png','','','','<p>Penambahan Mahasiswa untuk membantu</p>\r\n'),(6,6,'30 %','6F24kp7J-t2vPOfkp4_-mm_OiyFR0lws.png','kBmG96xR49nF5au2dN5Gu9ZJG0D89SaS.png','','','','<p>sudah membersihkan 30 meter</p>\r\n');
...
insert  into `termindayamas`(`id_termindayamas`,`id_daymas`,`keterangan`,`foto_1`,`foto_2`,`foto_3`,`foto_4`,`foto_5`,`deskripsi`) values (1,2,'sudah melewati tahap ','','',NULL,NULL,NULL,'batu sudah ditransfer, dan diterima dengan baik'),(2,4,'Acara menghadirkan Dr. Rezky','l86HUuwp5IoGM-Bj9vMtDKpxG1ylSHgd.jpg','alAFWZHe1PFVfKmvzAZzJxrwnhFazgmv.jpg','','','','<p>acara sangat menarik</p>\r\n');
...
insert  into `terminpembdes`(`id_terminpembdes`,`id_pembdes`,`keterangan`,`foto_1`,`foto_2`,`foto_3`,`foto_4`,`foto_5`,`deskripsi`) values (1,4,'Sudah puny','','',NULL,NULL,NULL,'sudah dicat '),(3,3,'Pembersihan Danau','FDNW5Ps8GnK3T9_lYukFKLf6RHfGwnJG.jpg','AP6zLQ6Xlzd2qzs4Jcb0sYGcQGsppXiE.jpg','','','','<p>Sudah bersih</p>\r\n');
...
insert  into `terminpenydes`(`id_terminpenydes`,`id_penydes`,`keterangan`,`foto_1`,`foto_2`,`foto_3`,`foto_4`,`foto_5`,`deskripsi`) values (1,3,'Sudah dila','','',NULL,NULL,NULL,'sudah diaspali dan diberi pasir jalan'),(2,5,'Sudah terpilih','NHP8QkoEBpd-IXpUDHn1_ep4UsImr33W.jpg','w0ggjbAm-o0Npgh2MqaYIOjZPxJhFIn_.jpg','','','','<p>Bapak Rudi dan Bapak Yudi terpilih</p>\r\n');
