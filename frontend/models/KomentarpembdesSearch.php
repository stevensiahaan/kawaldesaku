...
/**
 * KomentarpembdesSearch represents the model behind the search form about `app\models\Komentarpembdes`.
 */
class KomentarpembdesSearch extends Komentarpembdes
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id_komentar', 'id_terminpembdes'], 'integer'],
